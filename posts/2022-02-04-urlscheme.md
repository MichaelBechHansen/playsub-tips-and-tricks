---
layout: post
title: [2023.1] Url scheme automation
...
#### Repeat on/off/1
> playsubapp://set?shuffle=on<br>playsubapp://set?repeat=off<br>playsubapp://set?repeat=1<br>playsubapp://set?repeat=one
...
#### Play More Like current artist (Since version 2021.2)
